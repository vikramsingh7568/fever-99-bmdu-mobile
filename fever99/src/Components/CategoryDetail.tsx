...
const CategoryDetail = (props: any) => {
    ...
    return (
        <View style={{ width: width, height: height, backgroundColor: '#F1F8FF', }}>
            <Headerr secndheader={true} label='Book Category' btn={true} serviceId={props.route.params.data} btnlbl='Book Service' />
            <ScrollView contentContainerStyle={{ width: wp(95), alignSelf: 'center', marginTop: hp(2), paddingBottom: hp(20), marginBottom: 50 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", }}>
                    <Text></Text>
                    <Text style={{ color: 'black', fontSize: hp(1.95), fontFamily: mainFontBold }}>Charge: Rs. {serviceObj?.price}/-</Text>
                </View>
